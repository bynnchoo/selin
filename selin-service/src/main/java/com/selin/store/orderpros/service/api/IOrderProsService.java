package com.selin.store.orderpros.service.api;
...
public interface IOrderProsService {
	 ...
	 */
	public abstract Serializable save(OrderPros orderPros);
	 ...
	 * 按对象中的非空属性作为条件，进行删除
	 */
	public abstract void deleteByExample(OrderPros orderPros);
	 ...
	 * 按对象中的非空属性作为条件，进行修改
	 */
	public abstract void updateByExample(OrderPros orderPros);
	 ...
	 */
	public abstract Page page(Page page, OrderPros orderPros);
