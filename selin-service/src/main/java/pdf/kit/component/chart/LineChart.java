...
public abstract class LineChart {
	...
	public String draw(String title, String xLabel, String yLabel, List<Line> lineList, int picId) {
	...
	private String drawLineChar(String title, String xLabel, String yLabel, DefaultCategoryDataset dataSet, int picId)
			throws IOException {
		JFreeChart lineChartObject = ChartFactory.createLineChart(title, xLabel, // 横轴
				yLabel, // 纵轴
				dataSet, // 获得数据集
